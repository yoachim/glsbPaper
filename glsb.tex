...
If we use the circular speed of the \HI\ data from the literature, we end up with masses of $25\times 10^{11} \msun$ for Malin 2 and $6.5\times 10^{11} \msun$ for UGC 6614.  So that's dynamical to stellar mass ratios of 18 and 14 respectively.  %Looks like they both have M$_{\rm{HI}}$ around 3-4 $10^{10} \msun$.  
...
\caption{XXX--break this into 2 figures!  Fitting the line-of-sight velocity maps measured with Ppxf with the kinemetry package.  The dashed curve shows the expected stellar mass contribution to the rotation curve.  Vertical lines mark $R_e$ and $5R_e$.  \HI\ data from \citet{Pickering97}.  \label{malin_kinem}}
\end{figure*}
