...
\author{Peter Yoachim\altaffilmark{1}, Denise Schmitz\altaffilmark{4}, Sarah Loebman\altaffilmark{2}, SungWon Kwak\altaffilmark{5}, Victor P. Debattista\altaffilmark{3}
  }
...
\caption{Upper panels show kinematics from individual fibers, lower panels show the results after fibers have been binned into triples.  Left:  Stellar velocities measured with pPXF \citep{Cappellari04}. Middle:  Best fitting tilted ring model from kinemetry \citet{Krajn06}. Right: Best fit residuals.  \label{malin_kinem_fibers}}
\end{figure*}
...
\epsscale{1}
\plottwo{Plots/kinembinned_Malin2.eps}{Plots/kinem_HI_binned_Malin2.eps}
\caption{Rotation curves extracted from the best fitting models in Fig~\ref{malin_kinem_fibers}.  The dashed curves show the expected stellar mass contribution to the rotation curve.  Vertical lines mark $R_e$ and $5R_e$.  \HI\ data from \citet{Pickering97}.  \label{malin_kinem}}
\end{figure*}
