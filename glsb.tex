...
\citet{Wilkinson15} find -0.15 dex/$R_e$ gradients for early type galaxies and flat metallitcity gradients for late type galaxies. 
...
\citet{Hagen16} present the discovery of a GLSB system around UGC~1382.  As in this work, they find the best explination of the extended disk as being the remnants of an accreted drawf galaxy similar to the simulations of \citet{Pen06}. 
...
\caption{Upper panels show kinematics from individual fibers, lower panels show the results after fibers have been binned into tripples.  Left:  Stellar velocities measured with pPXF \citep{Cappellari04}. Middle:  Best fitting tilted ring model from kinemetry \citet{Krajn06}. Right: Best fit residuals.  \label{malin_kinem_fibers}}
\end{figure*}
...
\epsscale{1}
\plottwo{Plots/kinembinned_Malin2.eps}{Plots/kinem_HI_binned_Malin2.eps}
\caption{Rotation curves extracted from the best fitting model in Fig~\ref{malin_kinem_fibers}.  The dashed curve shows the expected stellar mass contribution to the rotation curve.  Vertical lines mark $R_e$ and $5R_e$.  \HI\ data from \citet{Pickering97}.  \label{malin_kinem}}
\end{figure*}
...
\caption{XXX-break into 2 figures! Fitting the velocity maps with kinemetry package. Vertical lines mark $R_e$ and $5R_e$.  The dashed lines shows a rotation curve based in the enclosed flux, normalized so that all the SDSS stellar mass is contained within $3R_e$.  \HI\ data from \citet{Pickering97}.\label{ugc_kinem}}
\end{figure*}
...
% LocalWords:  IFU UGC HSB SAURON ellipticals Spitzer IC Galaz
